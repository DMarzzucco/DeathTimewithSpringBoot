...
import { Frame, Frame1, ListJSON, TermiaList } from "../ListJs";
function JavaScript() {
    return (
        <>
        ...
        flex flex-col justify-center py-3 font-jet text-20 eight:text-15 sixmit:text-10">
                <div className="flex  flex-col  font-jet justify-between items-center w-full ">
                    <div className="flex flex-row justify-center items-center eight:flex-col">
                        ...
                        <h1 className="text-40 mx-4 text-yellow-400 m-0 eight:hidden">J a v a S c r i p t</h1>
                        <h1 className="text-30 mx-4 text-yellow-400 m-0 eight:block">JavaScript</h1>
                    </div>
