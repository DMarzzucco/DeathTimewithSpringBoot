...
function JavaScript() {
    return (
        ...
        flex flex-col justify-center items-start py-3 border-b font-jet text-20">
            ...
            <div className="flex  flex-col  font-jet justify-between
                      items-center w-full ">
                <div className="flex flex-row justify-center items-center">
                    <Link to={"https://developer.mozilla.org/en-US/docs/Web/JavaScript"}>
                        <FontAwesomeIcon icon={faSquareJs} className="
                             text-70 text-yellow-400" />
                    </Link>
                    <h1 className="text-40 mx-4 text-yellow-400 m-0">
                        J a v a S c r i p t
                    </h1>
                </div>
                <p className=" text-set ml-20">
            ...
            <div className="flex flex-col m-10 pt-3 justify-center items-start">
                ...
                <div className="mx-10">
                    ...
                    {/* listaJSON */}
                    <ul>
                        <ListJSON obj={"sdsdsd"} value={"mlmls"}/>
                    </ul>
                    {/* } */}
                    <p>
                        {"}"}
